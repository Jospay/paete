...
// Matches ProfileValidationRules::dateOfBirthRules() -> 'before:-18 years'.
    ...
    >
        ...
        <div class="grid gap-4 sm:grid-cols-2">
            ...
            <div class="grid gap-2">
                ...
                <p v-if="form.errors.mobile_number" class="text-sm text-destructive">
        ...
        <div class="grid gap-4 sm:grid-cols-2">
            ...
            <div class="grid gap-2">
                ...
                <p v-if="form.errors.civil_status" class="text-sm text-destructive">
        ...
        <div class="grid gap-4 sm:grid-cols-2">
            <div class="grid gap-2">
                ...
                <p v-if="form.errors.occupation" class="text-sm text-destructive">
            ...
            <div class="grid gap-2">
                ...
                <p v-if="form.errors.source_of_income" class="text-sm text-destructive">
        ...
        <div class="grid gap-4 sm:grid-cols-3">
            ...
            <div class="grid gap-2">
                ...
                <p v-if="form.errors.id_number" class="text-sm text-destructive">
